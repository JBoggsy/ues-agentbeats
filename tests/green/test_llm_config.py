...
class TestLLMFactoryCreate:
    ...
    @patch("src.green.llm_config.ChatOpenAI")
    ...
    @patch("src.green.llm_config.ChatAnthropic")
    ...
    @patch("src.green.llm_config.ChatGoogleGenerativeAI")
    ...
    @patch("src.green.llm_config.ChatOllama")
